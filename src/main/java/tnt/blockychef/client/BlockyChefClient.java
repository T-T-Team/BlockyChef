...
public final class BlockyChefClient {
    ...
    private void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(BlockyChefBlockEntities.TOASTER, ToasterBlockEntityRenderer::new);
    }
    ...
    private void registerScreenFactories() {
        ...
        MenuScreens.register(BlockyChefMenuTypes.GRILL, GrillScreen::new);
    }
