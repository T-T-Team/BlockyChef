...
public final class BlockRegistry {
    ...
    public static void register(BlockRegistryHelper helper) {
        ...
        helper.register("concrete_concrete_kitchen_counter", new KitchenCounterBlock(MultiVariantFurnitureBlock.Variant.FULL_CONCRETE));
        helper.register("concrete_plank_kitchen_counter", new KitchenCounterBlock(MultiVariantFurnitureBlock.Variant.MIXED_CONCRETE_TOP));
        helper.register("plank_concrete_kitchen_counter", new KitchenCounterBlock(MultiVariantFurnitureBlock.Variant.MIXED_WOOD_TOP));
        helper.register("plank_plank_kitchen_counter", new KitchenCounterBlock(MultiVariantFurnitureBlock.Variant.FULL_WOOD));
        helper.register("concrete_concrete_cooking_table", new CookingTableBlock(MultiVariantFurnitureBlock.Variant.FULL_CONCRETE));
        helper.register("concrete_plank_cooking_table", new CookingTableBlock(MultiVariantFurnitureBlock.Variant.MIXED_CONCRETE_TOP));
        helper.register("plank_concrete_cooking_table", new CookingTableBlock(MultiVariantFurnitureBlock.Variant.MIXED_WOOD_TOP));
        helper.register("plank_plank_cooking_table", new CookingTableBlock(MultiVariantFurnitureBlock.Variant.FULL_WOOD));
        helper.register("concrete_kitchen_cabinet", new KitchenCabinetBlock(MultiVariantFurnitureBlock.Variant.FULL_CONCRETE));
        helper.register("plank_kitchen_cabinet", new KitchenCabinetBlock(MultiVariantFurnitureBlock.Variant.FULL_WOOD));
        helper.register("concrete_concrete_kitchen_counter_corner", new KitchenCounterCornerBlock(MultiVariantFurnitureBlock.Variant.FULL_CONCRETE));
        helper.register("concrete_plank_kitchen_counter_corner", new KitchenCounterCornerBlock(MultiVariantFurnitureBlock.Variant.MIXED_CONCRETE_TOP));
        helper.register("plank_concrete_kitchen_counter_corner", new KitchenCounterCornerBlock(MultiVariantFurnitureBlock.Variant.MIXED_WOOD_TOP));
        helper.register("plank_plank_kitchen_counter_corner", new KitchenCounterCornerBlock(MultiVariantFurnitureBlock.Variant.FULL_WOOD));
        helper.register("concrete_concrete_kitchen_sink", new KitchenSinkBlock(MultiVariantFurnitureBlock.Variant.FULL_CONCRETE));
        helper.register("concrete_plank_kitchen_sink", new KitchenSinkBlock(MultiVariantFurnitureBlock.Variant.MIXED_CONCRETE_TOP));
        helper.register("plank_concrete_kitchen_sink", new KitchenSinkBlock(MultiVariantFurnitureBlock.Variant.MIXED_WOOD_TOP));
        helper.register("plank_plank_kitchen_sink", new KitchenSinkBlock(MultiVariantFurnitureBlock.Variant.FULL_WOOD));
