...
import tnt.blockychef.common.item.HydrationAdjustingItem;
...
public final class ItemRegistry {
    ...
    public static void register(RegisterEvent.RegisterHelper<Item> helper) {
        ...
        helper.register("almond", new HydrationAdjustingItem(new Item.Properties().food(FoodList.ALMOND), DrinkList.ALMOND));
        helper.register("avocado", new HydrationAdjustingItem(new Item.Properties().food(FoodList.AVOCADO), DrinkList.AVOCADO));
        helper.register("banana", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BANANA), DrinkList.BANANA));
        helper.register("black_olives", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BLACK_OLIVES), DrinkList.BLACK_OLIVES));
        ...
        helper.register("green_olives", new HydrationAdjustingItem(new Item.Properties().food(FoodList.GREEN_OLIVES), DrinkList.GREEN_OLIVES));
        helper.register("hazelnut", new HydrationAdjustingItem(new Item.Properties().food(FoodList.HAZELNUT), DrinkList.HAZELNUT));
        ...
        helper.register("orange", new HydrationAdjustingItem(new Item.Properties().food(FoodList.ORANGE), DrinkList.ORANGE));
        ...
        helper.register("vanilla_pods", new HydrationAdjustingItem(new Item.Properties().food(FoodList.VANILLA_PODS), DrinkList.VANILLA_PODS));
        helper.register("walnut", new HydrationAdjustingItem(new Item.Properties().food(FoodList.WALNUT), DrinkList.WALNUT));
        ...
        helper.register("fried_shrimp", new HydrationAdjustingItem(new Item.Properties().food(FoodList.FRIED_SHRIMP), DrinkList.FRIED_SHRIMP));
        helper.register("burnt_shrimp", new Item(new Item.Properties()));

        helper.register("apple_extract", new HydrationAdjustingItem(new Item.Properties(), DrinkList.APPLE_EXTRACT));
        helper.register("apple_half", new Item(new Item.Properties().food(FoodList.APPLE_HALF)));
        helper.register("apple_marmalade", new HydrationAdjustingItem(new Item.Properties().food(FoodList.APPLE_MARMALADE), DrinkList.APPLE_MARMALADE));
        helper.register("apple_slice", new Item(new Item.Properties().food(FoodList.APPLE_SLICE)));
        helper.register("avocado_slice", new HydrationAdjustingItem(new Item.Properties().food(FoodList.AVOCADO_SLICE), DrinkList.AVOCADO_SLICE));
        helper.register("banana_slice", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BANANA_SLICE), DrinkList.BANANA_SLICE));
        helper.register("bbq_sauce", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BBQ_SAUCE), DrinkList.BBQ_SAUCE));
        helper.register("beans", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BEANS), DrinkList.BEANS));
        helper.register("beef_burger_patty", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BEEF_BURGER_PATTY), DrinkList.BEEF_BURGER_PATTY));
        ...
        helper.register("bell_pepper_slice", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BELL_PEPPER_SLICE), DrinkList.BELL_PEPPER_SLICE));
        helper.register("black_olive_slice", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BLACK_OLIVE_SLICE), DrinkList.BLACK_OLIVE_SLICE));
        helper.register("blueberry_extract", new HydrationAdjustingItem(new Item.Properties(), DrinkList.BLUEBERRY_EXTRACT));
        helper.register("blueberry_marmalade", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BLUEBERRY_MARMALADE), DrinkList.BLUEBERRY_MARMALADE));
        helper.register("boiled_rice", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BOILED_RICE), DrinkList.BOILED_RICE));
        helper.register("bread_slice", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BREAD_SLICE), DrinkList.BREAD_SLICE));
        helper.register("broccoli_cuts", new HydrationAdjustingItem(new Item.Properties().food(FoodList.BROCCOLI_CUTS), DrinkList.BROCCOLI_CUTS));
        ...
        helper.register("cabbage_leaf", new HydrationAdjustingItem(new Item.Properties().food(FoodList.CABBAGE_LEAF), DrinkList.CABBAGE_LEAF));
        helper.register("carrot_extract", new HydrationAdjustingItem(new Item.Properties(), DrinkList.CARROT_EXTRACT));
        helper.register("carrot_slice", new Item(new Item.Properties().food(FoodList.CARROT_SLICE)));
        helper.register("cherry_extract", new HydrationAdjustingItem(new Item.Properties(), DrinkList.CHERRY_EXTRACT));
        helper.register("cherry_marmalade", new HydrationAdjustingItem(new Item.Properties().food(FoodList.CHERRY_MARMALADE), DrinkList.CHERRY_MARMALADE));
        helper.register("chicken_burger_patty", new HydrationAdjustingItem(new Item.Properties().food(FoodList.CHICKEN_BURGER_PATTY), DrinkList.CHICKEN_BURGER_PATTY));
        ...
        helper.register("cocoa_spread", new HydrationAdjustingItem(new Item.Properties().food(FoodList.COCOA_SPREAD), DrinkList.COCOA_SPREAD));
        helper.register("coconut_half", new Item(new Item.Properties().food(FoodList.COCONUT_HALF)));
        helper.register("coconut_milk", new HydrationAdjustingItem(new Item.Properties(), DrinkList.COCONUT_MILK));
        helper.register("coffee_beans", new HydrationAdjustingItem(new Item.Properties().food(FoodList.COFFEE_BEANS), DrinkList.COFFEE_BEANS));
        helper.register("coffee_powder", new Item(new Item.Properties()));
        helper.register("corn", new HydrationAdjustingItem(new Item.Properties().food(FoodList.CORN), DrinkList.CORN));
        helper.register("corn_meal", new HydrationAdjustingItem(new Item.Properties().food(FoodList.CORN_MEAL), DrinkList.CORN_MEAL));
        ...
        helper.register("oil", new HydrationAdjustingItem(new Item.Properties(), DrinkList.OIL));
