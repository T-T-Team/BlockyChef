...
public final class BlockyChefItems {
    ...
    @ObjectHolder(value = "blockychef:black_pepper_cluster", registryName = "item")
    ...
    @ObjectHolder(value = "blockychef:corn_cob", registryName = "item")
    ...
    @ObjectHolder(value = "blockychef:portobello_mushroom", registryName = "item")
    public static final Item PORTOBELLO_MUSHROOM = null;
    @ObjectHolder(value = "blockychef:bean_pod", registryName = "item")
    public static final Item BEAN_POD = null;
    @ObjectHolder(value = "blockychef:peanut", registryName = "item")
    ...
    @ObjectHolder(value = "blockychef:ginger_root", registryName = "item")
    public static final Item GINGER_ROOT = null;
    @ObjectHolder(value = "blockychef:tea_leaf", registryName = "item")
    ...
    @ObjectHolder(value = "blockychef:rice_crop", registryName = "item")
    public static final Item RICE_CROP = null;
    @ObjectHolder(value = "blockychef:oat_crop", registryName = "item")
    public static final Item OAT_CROP = null;
    @ObjectHolder(value = "blockychef:mustard_pods", registryName = "item")
    ...
    @ObjectHolder(value = "blockychef:spinach_leaf", registryName = "item")
    ...
    @ObjectHolder(value = "blockychef:empty_jar", registryName = "item")
    public static final Item EMPTY_JAR = null;
    @ObjectHolder(value = "blockychef:empty_glass", registryName = "item")
