...
public final class BlockyChefBlockEntities {
    ...
    private static final String KEY = "block_entity_type";
    ...
    @ObjectHolder(value = "blockychef:kitchen_counter_corner", registryName = KEY)
    ...
    @ObjectHolder(value = "blockychef:kitchen_sink", registryName = KEY)
