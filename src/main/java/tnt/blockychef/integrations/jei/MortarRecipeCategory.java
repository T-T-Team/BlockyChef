...
public class MortarRecipeCategory extends BlockyChefRecipeCategory<MortarRecipe> {

    private final IDrawableAnimated arrow;

    public MortarRecipeCategory(IGuiHelper helper) {
        super(helper, "mortar_and_pestle");
    ...
    protected ItemStack getIconStack() {
        return new ItemStack(BlockyChefBlocks.DEEPSLATE_MORTAR_AND_PESTLE);
    }
    ...
    public RecipeType<MortarRecipe> getRecipeType() {
        return JeiIntegrationPlugin.MORTAR_AND_PESTLE;
    }
}
