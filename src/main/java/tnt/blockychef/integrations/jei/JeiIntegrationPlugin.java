...
public class JeiIntegrationPlugin implements IModPlugin {
    ...
    static final RecipeType<TeapotRecipe> TEAPOT = new RecipeType<>(BlockyChef.resource("teapot"), TeapotRecipe.class);
    static final RecipeType<SaucepanRecipe> SAUCEPAN = new RecipeType<>(BlockyChef.resource("saucepan"), SaucepanRecipe.class);
    static final RecipeType<GrillRecipe> GRILL = new RecipeType<>(BlockyChef.resource("grill"), GrillRecipe.class);
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(TEAPOT, getRecipes(BlockyChefRecipeTypes.TEAPOT_RECIPE));
        registration.addRecipes(SAUCEPAN, getRecipes(BlockyChefRecipeTypes.SAUCEPAN_RECIPE));
        registration.addRecipes(GRILL, getRecipes(BlockyChefRecipeTypes.GRILL_RECIPE));
    }
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        ...
        registration.addRecipeCategories(
                ...
                new TeapotRecipeCategory(helper),
                new SaucepanRecipeCategory(helper),
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(BlockyChefBlocks.TEAPOT), TEAPOT);
        registration.addRecipeCatalyst(new ItemStack(BlockyChefBlocks.SAUCEPAN), SAUCEPAN);
        registration.addRecipeCatalyst(new ItemStack(BlockyChefBlocks.GRILL), GRILL);
    }
