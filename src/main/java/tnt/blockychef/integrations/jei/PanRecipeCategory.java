...
public class PanRecipeCategory extends BlockychefFluidRecipeCategory<PanRecipe> {

    private final IDrawableAnimated flame;
    private final IDrawableAnimated arrow;

    public PanRecipeCategory(IGuiHelper helper) {
        super(helper, "pan");
    ...
    protected ItemStack getIconStack() {
        return new ItemStack(BlockyChefBlocks.PAN);
    }

    @Override
    public RecipeType<PanRecipe> getRecipeType() {
        return JeiIntegrationPlugin.PAN;
    }
    ...
    public void draw(PanRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        GraphicsHelper.drawAlignedText(guiGraphics, getValueLabel(recipe.getRequiredOilAmount()), font, HorizontalAlignment.LEFT, VerticalAlignment.CENTER, 0, 0, 100, 18, 0xFF808080, false, 20, 39);
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, PanRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, 1, 39).addFluidStack(BlockyChefFluids.OIL_FLUID.get(), 1000);
    }
}
