...
public class BarrelRecipeCategory extends BlockyChefRecipeCategory<BarrelRecipe> {
    ...
    protected ItemStack getIconStack() {
        return new ItemStack(BlockyChefBlocks.OAK_BARREL);
    }
    ...
    public void draw(BarrelRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        drawCentered(getTimeLabel(recipe.getFermentTime()).getString(), guiGraphics, 0, 3, 0x808080, false);
    ...
    public RecipeType<BarrelRecipe> getRecipeType() {
        return JeiIntegrationPlugin.BARREL;
    }
}
